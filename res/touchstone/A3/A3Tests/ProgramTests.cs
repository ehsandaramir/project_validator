...
namespace A3.Tests
{
    ...
    public class ProgramTests
    {
        ...
        [TestMethod(), Timeout(1000)]
        [DeploymentItem("TestData", "A3_TestData")]
        public void Graded_FibonacciLastDigit_CacheLessTest()
        {
            TestTools.RunLocalTest("A3", Program.ProcessFibonacci_LastDigit_CacheLess, "TD2");
        }

        [TestMethod(), Timeout(1000)]
        [DeploymentItem("TestData", "A3_TestData")]
        public void Graded_GDCTest()
        {
